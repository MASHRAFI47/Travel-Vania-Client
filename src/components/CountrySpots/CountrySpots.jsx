                ...
                filteredCountry.map(country => <div key={country._id}>
                    <div>
                        <div className="card border my-10 bg-base-100 shadow-xl">
                            <figure><img src={country.imageURL} className="h-[17rem]" alt="Shoes" /></figure>
                            <div className="card-body">
                                ...
                                <p className="text-xl mt-2"><span className="font-bold">Description:</span>{country.short_description.slice(0,70).concat('...')}</p>
